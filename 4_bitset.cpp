...
int main(){
    ...
    bitset<8> bit3 = bit1 & bit2; // 0010 0000
    bitset<8> bit4 = bit1 | bit2; // 0111 1111
    bitset<8> bit5 = bit1 ^ bit2; // 0101 1111
    bitset<8> bit6 = ~bit1; // 1101 1111
    bitset<8> bit7 = bit2 << 1; // 0100 0000
    bitset<8> bit8 = bit2 >> 1; // 0001 0000
